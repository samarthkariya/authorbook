...
/**
 * The table class for the &quot;Assignment_Book&quot; database table.
 *
...
public class BookTable extends BaseTable<BookTable> {
	...
	public final Column<BookTable, String> bookDescription = createColumn(
		"bookDescription", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<BookTable, Long> bookPrice = createColumn(
		"bookPrice", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);

	private BookTable() {
		super("Assignment_Book", BookTable::new);
	}
