 ...
 * <code>com.author_book.service.impl.AuthorLocalServiceImpl</code> and
...
public class AuthorLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.author_book.service.impl.AuthorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void addBookAuthor(long bookId, Author author) {
	...
	public static void addBookAuthors(long bookId, List<Author> authors) {
	...
	public static void deleteBookAuthor(long bookId, Author author) {
	...
	public static void deleteBookAuthors(long bookId, List<Author> authors) {
	...
	public static List<Author> findByGrpId(long groupId) {
		return getService().findByGrpId(groupId);
	}
	...
	public static List<com.author_book.model.Book> getAuthorBooks(
		long authorId) {
	...
	public static List<Author> getBookAuthors(long bookId) {
		return getService().getBookAuthors(bookId);
	}

	public static List<Author> getBookAuthors(long bookId, int start, int end) {
	...
	public static List<Author> getBookAuthors(
		...
		return getService().getBookAuthors(
	...
	public static List<Author> searchAuthors(
		...
		return getService().searchAuthors(
	...
	public static void UpdateAuthor(
		...
		getService().UpdateAuthor(authorId, authorName, bookId, serviceContext);
	}
