...
public interface AuthorLocalService
	...
	public Author AddAuthor(
			...
			ServiceContext serviceContext, String userName, String authorName,
			String[] bookId)
	...
	public List<Author> searchAuthors(
			...
			String orderByType, int start, int end, Locale locale)
		throws PortalException;
