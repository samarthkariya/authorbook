...
import com.author_book.service.BookLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.author_book.service.impl.BookLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.author_book.service.impl.BookLocalServiceImpl
 * @generated
 */
public abstract class BookLocalServiceBaseImpl
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BookLocalServiceImpl#deleteBook(Book) to avoid orphaned data");
		}
	...
	public List<Book> getAuthorBooks(long authorId, int start, int end) {
		return bookPersistence.getAuthorBooks(authorId, start, end);
	}
	...
	public List<Book> getAuthorBooks(
		...
		return bookPersistence.getAuthorBooks(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BookLocalServiceBaseImpl.class);
