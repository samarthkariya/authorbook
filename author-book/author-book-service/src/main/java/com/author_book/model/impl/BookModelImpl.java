...
import com.author_book.model.BookModel;
...
/**
 * The base model implementation for the Book service. Represents a row in the &quot;Assignment_Book&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class BookModelImpl extends BaseModelImpl<Book> implements BookModel {
	 ...
	 */
	public static final String TABLE_NAME = "Assignment_Book";
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"bookName", Types.VARCHAR}, {"bookDescription", Types.VARCHAR},
		{"bookPrice", Types.BIGINT}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("bookDescription", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("bookPrice", Types.BIGINT);
	}

	public static final String TABLE_SQL_CREATE =
		"create table Assignment_Book (uuid_ VARCHAR(75) null,bookId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,bookName VARCHAR(75) null,bookDescription VARCHAR(75) null,bookPrice LONG)";

	public static final String TABLE_SQL_DROP = "drop table Assignment_Book";

	public static final String ORDER_BY_JPQL = " ORDER BY book.groupId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Assignment_Book.groupId ASC";
	...
	public static final String MAPPING_TABLE_ASSIGNMENT_AUTHOR_BOOK_NAME =
		"Assignment_Author_Book";

	public static final Object[][]
		MAPPING_TABLE_ASSIGNMENT_AUTHOR_BOOK_COLUMNS = {
			{"companyId", Types.BIGINT}, {"authorId", Types.BIGINT},
			{"bookId", Types.BIGINT}
		};

	public static final String MAPPING_TABLE_ASSIGNMENT_AUTHOR_BOOK_SQL_CREATE =
		"create table Assignment_Author_Book (companyId LONG not null,authorId LONG not null,bookId LONG not null,primary key (authorId, bookId))";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("bookPrice", Book::getBookPrice);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"bookDescription",
				(BiConsumer<Book, String>)Book::setBookDescription);
			attributeSetterBiConsumers.put(
				"bookPrice", (BiConsumer<Book, Long>)Book::setBookPrice);
	...
	public Object clone() {
		...
		bookImpl.setBookPrice(getBookPrice());
	...
	public Book cloneWithOriginalValues() {
		...
		bookImpl.setBookDescription(
			this.<String>getColumnOriginalValue("bookDescription"));
		bookImpl.setBookPrice(this.<Long>getColumnOriginalValue("bookPrice"));
	...
	public int compareTo(Book book) {
		...
		if (getGroupId() < book.getGroupId()) {
			value = -1;
		}
		else if (getGroupId() > book.getGroupId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public CacheModel<Book> toCacheModel() {
		...
		bookCacheModel.bookPrice = getBookPrice();
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("bookDescription", _bookDescription);
		_columnOriginalValues.put("bookPrice", _bookPrice);
	}
	...
	static {
		...
		columnBitmasks.put("bookName", 256L);

		columnBitmasks.put("bookDescription", 512L);

		columnBitmasks.put("bookPrice", 1024L);
