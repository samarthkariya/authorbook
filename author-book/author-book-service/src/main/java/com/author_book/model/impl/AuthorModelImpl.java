...
import com.author_book.model.AuthorModel;
...
/**
 * The base model implementation for the Author service. Represents a row in the &quot;Assignment_Author&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AuthorModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Assignment_Author";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Assignment_Author (uuid_ VARCHAR(75) null,authorId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,authorName VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table Assignment_Author";

	public static final String ORDER_BY_JPQL = " ORDER BY author.groupId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Assignment_Author.groupId ASC";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("authorName", Author::getAuthorName);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"authorName",
				(BiConsumer<Author, String>)Author::setAuthorName);
	...
	public int compareTo(Author author) {
		...
		if (getGroupId() < author.getGroupId()) {
			value = -1;
		}
		else if (getGroupId() > author.getGroupId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	static {
		...
		columnBitmasks.put("authorName", 256L);
